...
export default function ToDoList() {
    ...
    const agregarTarea = ( ) => {
      if(nuevaTarea.trim()){
        ...
        // limpia el input al añadir una nueva tarea
        setNuevaTarea("")
      }
    }

    //cambia completado de true a false y viceversa
...
const renderItem = ({ item }: { item: Tarea }) => (
    <View style={styles.itemContainer}>
        <TouchableOpacity style={styles.item} onPress={() => toggleTarea(item.id)}>
            ...
            <Text style={[styles.textoTarea, item.completada && styles.textoTareaCompletado]}>
                {item.texto}
            </Text>
        </TouchableOpacity>
